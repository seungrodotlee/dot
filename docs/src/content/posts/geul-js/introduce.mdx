...
![Main Image](../../images/geul-js/head-motion.gif)
...
- [`useGeul`](./react/use-geul/?openedMenus=React)
- [`useDynamicGeul`](./react/use-dynamic-geul/?openedMenus=React)
- [`useGeulPipe`](./react/use-geul-pipe/?openedMenus=React)
